...
import { defaultConfig, normalizeConfig, isRecord } from "../core/core.js";
/** Default plugin state dir: $DSH_HOME/storages/dsh-usage-monitor (CLI: ~/.dsh/…). */
export function defaultStorageDir(storageDirOverride) {
    if (storageDirOverride !== undefined && storageDirOverride !== '')
...
export class ConfigStore {
    ...
    constructor(storageDir, rowConfig) {
