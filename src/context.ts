...
export interface SessionReadHandleLike {
  header?: SessionHeaderRecord
  read(offset: number, length?: number, options?: unknown): Promise<{ events?: SessionEventRecord[] }>
...
export interface SessionPersistenceLike {
  ...
  readFrom?(id: string, fromSeq: number): Promise<{ events?: SessionEventRecord[] }>
}
...
export interface CordisContextLike {
   ...
   */
  on(event: string, listener: (...args: never[]) => void, options?: { global?: boolean; prepend?: boolean }): (() => void) | void
